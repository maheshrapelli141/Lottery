...
<div ng-if="values.todayHoliday==false">
        <?php
        $onTime = strtotime("8:30");
        $offTime = strtotime("22:15");

        if(time()<$onTime || time()>$offTime){
            if(time()>strtotime("00:00")){
                echo '<div class="off-box">
                 <div class="off-text">Website is closed , opens tomorrow 8:30 AM</div>
             </div>';
            } else {
                echo '<div class="off-box">
                 <div class="off-text">Website is closed , opens today 8:30 AM</div>
             </div>';
            }
        }
        else {
    ...
    <div ng-if="values.todayHoliday==true" class="off-box">
        <h3 class="closed-text">Today is Closed</h3>
    </div>
</div><br/>
